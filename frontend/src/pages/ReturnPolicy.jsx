...
const ReturnPolicy = () => {
  return (
    <div style={textualStyle}>
      ...
      <h4 style={{ color: '#0cea35', marginTop: '25px', marginBottom: '10px' }}>1. Eligibility for Returns</h4>
      ...
      <h4 style={{ color: '#0cea35', marginTop: '25px', marginBottom: '10px' }}>2. Refund Processing</h4>
      <p style={{ marginBottom: '15px' }}>
      ...
      <h4 style={{ color: '#0cea35', marginTop: '25px', marginBottom: '10px' }}>3. Exempted Output Goods</h4>
      <p style={{ marginBottom: '15px' }}>
      ...
      <h4 style={{ color: '#0cea35', marginTop: '25px', marginBottom: '10px' }}>4. Shipping Transit Costs</h4>
      <p>
